...
cd /etc/ocserv/
rm -rf ocserv.conf
wget https://github.com/kyledong/ocserv/blob/master/ocserv.conf
#
cd /root/anyconnect
wget https://github.com/kyledong/ocserv/blob/master/gen-client-cert.sh
wget https://github.com/kyledong/ocserv/blob/master/user_add.sh
wget https://github.com/kyledong/ocserv/blob/master/user_del.sh
